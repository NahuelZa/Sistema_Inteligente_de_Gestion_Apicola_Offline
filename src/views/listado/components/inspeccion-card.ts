...
export class InspeccionCard extends LitElement {
    ...
    private getColmenaLabel(): string {
        ...
        return colmena ? `Colmena ${colmena.numeroColmena}` : "Sin Colmena";
    }
        ...
        return html`
            <wa-card id="card-inspeccion-${this.inspeccion.id}">
                <div slot="header" class="wa-cluster wa-gap-xs wa-align-items-center">
                    ...
                    <strong class="wa-heading-s">Inspección - ${colmenaLabel}</strong>
                </div>
              ...
              ${this.inspeccion.fecha
                    ...
                    <div class="wa-cluster wa-gap-xs" style="flex-wrap: wrap;">
                        ...
                        >
                            <wa-icon slot="start"
                                     name=${this.inspeccion.reinaVista ? "circle-check" : "circle-xmark"}></wa-icon>
                        ...
                        >
                            <wa-icon slot="start"
                                     name=${this.inspeccion.tienePostura ? "circle-check" : "circle-xmark"}></wa-icon>
                    ...
                    ${notas
                            ? html`
                                <div class="wa-cluster wa-gap-xs wa-align-items-start wa-body-s wa-color-text-normal">
                                    <wa-icon name="note-sticky" class="wa-color-text-quiet"
                                             style="margin-top: 3px;"></wa-icon>
                                    <span>${notas}</span>
                                </div>
                            `
                            : nothing}
